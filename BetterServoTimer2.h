/*
  BetterServoTimer2.h - Interrupt driven Servo library for Arduino using Timer2- Version 0.1
...
/* 
  ...
  The library takes about 824-ish bytes of program memory and 32+(1*servos) bytes of SRAM. 

  The pulse width timing is accurate to within 1%
*/

/*
  This library was updated to BetterServoTimer2 by Eric Chen 2026 to adjust min and max pulse widths and finish the implementation of attach(pin, minPulseWidth, maxPulseWidth).
*/

// ensure this library description is only included once
#ifndef BetterServoTimer2_h
#define BetterServoTimer2_h
